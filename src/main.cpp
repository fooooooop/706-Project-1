...
// #define NO_HC-SR04 //Uncomment if HC-SR04 ultrasonic ranging sensor is not
// attached. #define NO_BATTERY_V_OK //Uncomment if BATTERY_V_OK if you do not
// care about battery damage.
